  ...
  return (
    <section className="max-w-frame mx-auto text-center">
      ...
      >
        <Carousel
          opts={{
            align: "center",  // Change alignment to center
          }}
          className="w-full mb-6 md:mb-9"
        >
          <CarouselContent className="mx-4 xl:mx-0 flex justify-center space-x-4 sm:space-x-5">
            {data.map((product) => (
              <CarouselItem
                key={product.id}
                className="w-full max-w-[198px] sm:max-w-[295px] flex justify-center pl-0"
              >
